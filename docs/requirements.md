...
- Đặt trước (Reservation): Độc giả chọn sách đang bận và tạo yêu cầu đặt trước. Lưu thông tin vào bảng library_management_reservation. Nhân viên xử lý đặt trước khi sách được trả về.
...
+ Quy tắc Đặt trước: Sách đặt trước chỉ được giữ tại quầy trong vòng 48 giờ. Sau thời gian này nếu độc giả không đến lấy, hệ thống tự động chuyển lượt cho người tiếp theo hoặc đưa lại vào kho.
