...
1. Tìm kiếm sách: Cho phép độc giả tìm kiếm sách theo tên, tác giả hoặc thể loại.
2. Xem chi tiết sách: Hiển thị thông tin chi tiết và tình trạng (còn/đang mượn) của sách.
3. Đặt trước sách: Cho phép độc giả đặt trước khi sách không còn bản sao khả dụng.
4. Check-out sách (Mượn sách): Nhân viên thực hiện cho độc giả mượn sách và cập nhật hệ thống.
5. Check-in sách (Trả sách): Nhân viên xử lý việc trả sách và tính phí phạt nếu có.
6. Xử lý đặt trước: Nhân viên quản lý danh sách chờ và thông báo khi sách có sẵn.
7. Quản lý danh mục sách: Admin thêm, sửa, xóa các danh mục sách.
8. Quản lý tác giả và nhà xuất bản: Admin quản lý thông tin tác giả và nhà xuất bản.
9. Cấu hình quy định: Admin thiết lập các quy định như thời gian mượn, số sách tối đa và mức phí phạt.
