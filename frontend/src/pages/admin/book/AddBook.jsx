    ...
    return (
        <div className='tw-p-6 tw-max-w-md tw-mx-auto tw-bg-pink-300 tw-rounded-2xl tw-shadow-lg'>
            ...
            <form className='tw-flex tw-flex-col tw-gap-4' onSubmit={handleSubmit}>
                ...
                {/* IMAGE */}
                <label htmlFor="book-image" className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-w-full tw-py-4 tw-border tw-border-dashed tw-border-gray-400 tw-rounded-xl tw-cursor-pointer tw-bg-gray-50 hover:tw-bg-gray-100 tw-transition-all ">
