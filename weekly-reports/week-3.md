...
|------------------------|------------|---------------------------------|
| Trần Khánh An          | 2351050004 | Database design, API design     |
| Phùng Thị Kim Ngân     | 2354050073 | Kiến trúc + Test Strategy       |
...
|------------------------|------------------------------------------|
| Trần Khánh An          |  Thiết kế thêm api + phân quyền          |
| Phùng Thị Kim Ngân     |  Tìm thêm dữ liệu test và dữ liệu cho db |
